...
public class RandomMovementAI : MonoBehaviour
{
    ...
    [Header("D�tection d'obstacles")]
    public LayerMask obstacleLayer;

    [Tooltip("Distance de d�tection des obstacles devant l'entit�")]
    public float obstacleDetectionDistance = 1f;

    [Tooltip("Rayon pour v�rifier si une position est libre")]
    ...
    {
        // Aucune layer configurée : toutes les positions sont valides
        ...
        {
            // Exclure le GameObject lui-même et tous ses enfants (ex: quad impostor avec collider)
