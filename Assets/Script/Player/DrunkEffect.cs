...
public class DrunkEffect : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (drunkVolume != null && drunkVolume.sharedProfile != null)
        {
            ...
            Debug.Log("DrunkEffect initialis� avec succ�s");
        }
        else
        {
            Debug.LogWarning("DrunkVolume n'est pas assign� correctement !");
        }
    }
    ...
    public void ApplyDrunkEffect(float duration, float damageBoost)
    {
        ...
        if (isDrunk)
        {
            ...
            Debug.Log($"Bi�re suppl�mentaire ! Stack : {currentBeerStack}/{maxBeerStack}");
    ...
    private IEnumerator FadeInEffect()
    {
        ...
        Debug.Log($"Effet d'ivresse activ� ! Stack : {currentBeerStack}");
    }
    ...
    private IEnumerator FadeOutEffect()
    {
        ...
        UpdateVolumeEffects(0f);
        Debug.Log("Effet d'ivresse termin�");
    }
